...
if(document.querySelector( '#menu_main' )){
    ...
    let counter = 0;
    if(catalog_tags_btn){
        if(catalog_tags.length > 5){
            catalog_tags_btn.classList.add('catalog-page__tags-show-btn_visible');
            ...
            catalog_tags_btn.classList.remove('catalog-page__tags-show-btn_visible');
        }
    ...
    if(document.querySelector('.catalog-float-buttons')){
